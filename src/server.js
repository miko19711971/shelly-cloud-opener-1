...
const earlyCheckinAnswers = {
  en: "Early check-in is possible only if the apartment is ready. Standard check-in starts at 15:00. We can confirm on the same day.",
  it: "Il check-in anticipato è possibile solo se l’appartamento è pronto. Il check-in standard è dalle 15:00. Possiamo confermare il giorno stesso.",
  fr: "L’arrivée anticipée est possible uniquement si l’appartement est prêt. Le check-in standard commence à 15h00. Nous confirmerons le jour même.",
  de: "Ein früher Check-in ist nur möglich, wenn die Wohnung bereits bereit ist. Standard-Check-in ist ab 15:00. Wir bestätigen am selben Tag.",
  es: "El check-in temprano es posible solo si el apartamento está listo. El check-in estándar empieza a las 15:00. Lo confirmamos el mismo día."
};
...
const earlyCheckoutAnswers = {
  ...
  fr: "Un départ anticipé est possible selon notre planning de ménage. Le check-out standard est avant 11h00. Indiquez l’heure souhaitée et nous confirmerons.",
  de: "Ein früher Check-out ist möglich, wenn es in unseren Reinigungsplan passt. Der Standard-Check-out ist bis 11:00. Bitte nennen Sie Ihre Wunschzeit, dann bestätigen wir.",
